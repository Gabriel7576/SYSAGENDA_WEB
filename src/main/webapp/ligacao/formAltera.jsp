			...
			<td><table width="100%" border="0">
					<tr align="center" valign="top">
						...
						<td width="80%">
							...
							<form id="formulario" name="formulario" method="get" action="altera">
								<table width="100%">
									<tr>
										<td>Ligaçâo</td>
									</tr>
								...
								<table width="100%">
									<tr>
										...
										<td width="66%"><label for="nome2"></label> 
										<select name="codContato" id="codContato">
												<option value="${contato.getCodContato()}">${contato}</option>
										</select>
										<INPUT TYPE="hidden" NAME="codLigacao" VALUE="${codLigacao}">
										</td>
									</tr>
									<tr>
										<td>Data e Hora:</td>
										<td><label for="Data"></label> <input
											...
											max="2200-12-31T00:00" value="${data}" /></td>
									</tr>
									<tr>
										<td valign="top">Observação:</td>
										<td><label for="Obs"></label> <textarea name="observ"
												id="observ" cols="45" rows="3" style="resize: none">${observacao}</textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
