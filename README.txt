...
a persistence unit "sysagendaPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/br/com/gabriel/sysagenda/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "sysagenda/pom.xml":
...
artifact ("sysagenda.war") is already built. You can build
